...
public class GameStateDTO {
    ...
    public void setTimeLeftSeconds(int timeLeftSeconds) { this.timeLeftSeconds = timeLeftSeconds; }
    ...
    public int getPlayer1Tokens() { return player1Tokens; }
    public void setPlayer1Tokens(int player1Tokens) { this.player1Tokens = player1Tokens; }

    public List<CardDTO> getPlayer1Timeline() { return player1Timeline; }
    public void setPlayer1Timeline(List<CardDTO> player1Timeline) { this.player1Timeline = player1Timeline; }
    ...
    public int getPlayer2Tokens() { return player2Tokens; }
    public void setPlayer2Tokens(int player2Tokens) { this.player2Tokens = player2Tokens; }
